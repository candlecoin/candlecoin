...
!define URL http://www.candle.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/candle.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\candle-qt.exe
...
OutFile candle-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/candle-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/candled.exe
    ...
    #Delete /REBOOTOK $INSTDIR\candle.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\candle-qt.exe
