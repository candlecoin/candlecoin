...
private slots:
    ...
    void on_BuyCD_clicked();
    void on_SellCDBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputCD_textChanged(const QString &arg1);
    ...
    QString BuyCD(QString OrderType, double Quantity, double Rate);
    QString SellCD(QString OrderType, double Quantity, double Rate);
